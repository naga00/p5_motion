...
SyntaxHighlighter.brushes.Processing = function()
{
	...
	this.regexList = [
		...
		{ regex: new RegExp(this.getKeywords(keywords1), 'gm'),		css: 'functions' },
		{ regex: new RegExp(this.getKeywords(keywords2), 'gm'),		css: 'keyword' },
		{ regex: new RegExp(this.getKeywords(keywords3), 'gm'),		css: 'color1' }
		];
};
