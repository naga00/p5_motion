Ball[] particles;
static final int numParticles = 500;
float minDist = 50;
float springAmount = 0.0002;

void setup() {
  size(960*2, 540*2, P3D);
  frameRate(60);
